...
const (
	PlayersService_UploadPlayerFile_FullMethodName = "/players.PlayersService/UploadPlayerFile"
)
...
type PlayersServiceClient interface {
	UploadPlayerFile(ctx context.Context, in *UploadPlayerFileRequest, opts ...grpc.CallOption) (*UploadPlayerFileResponse, error)
}
...
func (c *playersServiceClient) UploadPlayerFile(ctx context.Context, in *UploadPlayerFileRequest, opts ...grpc.CallOption) (*UploadPlayerFileResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UploadPlayerFileResponse)
	err := c.cc.Invoke(ctx, PlayersService_UploadPlayerFile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PlayersServiceServer interface {
	UploadPlayerFile(context.Context, *UploadPlayerFileRequest) (*UploadPlayerFileResponse, error)
...
func (UnimplementedPlayersServiceServer) UploadPlayerFile(context.Context, *UploadPlayerFileRequest) (*UploadPlayerFileResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UploadPlayerFile not implemented")
}
...
func _PlayersService_UploadPlayerFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UploadPlayerFileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PlayersServiceServer).UploadPlayerFile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PlayersService_UploadPlayerFile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlayersServiceServer).UploadPlayerFile(ctx, req.(*UploadPlayerFileRequest))
	}
...
var PlayersService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "UploadPlayerFile",
			Handler:    _PlayersService_UploadPlayerFile_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "grpc/players.proto",
}
